...
# 打开文件
with open('../Demo_06/results/Dst.txt', 'r') as file:
...
# plt.ylabel('Flow Delay(μs)', fontsize=22)
# # 限制显示范围
# plt.xlim(0,500)
# plt.ylim(70,115)
...
plt.plot(time_1,delay_table_1,color='g',label='pf1') # ES1
plt.plot(time_3,delay_table_3,color='y',label='sf1') # ES3
plt.plot(time_4,delay_table_4,color='r',label='pf2') # ES4
plt.plot(time_5,delay_table_5,color='m',label='pf3') # ES5
plt.plot(time_7,delay_table_7,color='k',label='sf2') # ES7
# 图例设置
